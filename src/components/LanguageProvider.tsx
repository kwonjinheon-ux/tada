...
const copy = {
  en: {
    ...
    location: "Location", comingSoon: "Coming soon", createPostAction: "New post", createServiceAction: "List a service",
    marketIntroTitle: "Good deals, close to home.", marketIntroDescription: "Find what is new in your neighbourhood and trade with the people next door.",
  ...
  ko: {
    ...
    marketIntroTitle: "가까운 곳에서 찾는, 좋은 거래.", marketIntroDescription: "우리 동네의 새로운 상품을 발견하고, 이웃과 쉽고 빠르게 거래해 보세요.",
