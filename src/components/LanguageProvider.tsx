...
const copy = {
  ...
  ko: {
    search: "물품 검색...", searchCommunity: "커뮤니티 글 검색...", searchServices: "서비스 검색...", market: "마켓", jobs: "일자리", services: "서비스", community: "커뮤니티", create: "등록", home: "홈", messages: "메시지", categories: "카테고리", more: "더보기",
