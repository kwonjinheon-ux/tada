...
const copy = {
  ...
  ko: {
    ...
    createListing: "상품 등록", totalListings: "개 등록 상품", noListingsYet: "등록된 상품이 없습니다", firstListingHint: "첫 상품을 등록하고 Tada에서 판매를 시작해 보세요.", available: "판매 가능", pending: "거래 대기", soldOut: "판매 완료", noMatchingListings: "일치하는 상품이 없습니다", tryDifferentSearch: "다른 검색어나 카테고리를 시도해 보세요.", category: "카테고리", condition: "상품 상태", applyFilters: "필터 적용", maxPrice: "최대 가격 (NZD)", any: "전체", newest: "최신순", lowToHigh: "낮은 가격순", highToLow: "높은 가격순", recommended: "추천순", brandNew: "새 상품", likeNew: "새것 같은 상태", excellent: "매우 좋음", good: "좋음", fair: "보통", newlyListed: "새로 등록됨", promotion: "프로모션", viewListing: "상품 보기", imageUnavailable: "이미지를 불러올 수 없음", saveListing: "상품 찜하기", viewMode: "보기 방식", listView: "목록 보기", gridView: "격자 보기", quickCategories: "빠른 카테고리", sortListings: "정렬", markAllRead: "모두 읽음 처리", keywordAlerts: "키워드 알림", keywordAlertsHint: "원하는 조건과 일치하는 새 마켓 상품이 등록되면 알려드립니다.", addKeyword: "키워드 추가", yourKeywords: "내 키워드", noKeywordAlerts: "아직 키워드 알림이 없습니다", addKeywordHint: "새 상품 알림을 받으려면 키워드를 추가하세요.", keywordPlaceholder: "예: 노트북, 소파, 자전거", keywordInputLabel: "키워드", keywordNoticeLabel: "키워드 알림 안내", keywordNotice: "최대 20개의 키워드를 추가해 마켓 검색을 더 개인화하세요.",
  },
} as const;
