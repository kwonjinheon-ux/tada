...
const copy = {
  en: {
    ...
    marketIntroTitle: "Deals next door.", marketIntroDescription: "See what your neighbours listed today.", marketIntroSecondhandTitle: "Buy it pre-loved.", marketIntroSecondhandDescription: "Good condition, fair price, five minutes away.", marketIntroGarageSaleTitle: "Raid a local garage.", marketIntroGarageSaleDescription: "Real sales nearby. Get there early.", marketIntroMovingSaleTitle: "They are moving. You are winning.", marketIntroMovingSaleDescription: "Everything must go — claim it first.", marketIntroTwoDollarShopTitle: "Everything is $2.", marketIntroTwoDollarShopDescription: "Small prices, quick wins. Stock up.", marketIntroGroupBuyTitle: "Team up. Pay less.", marketIntroGroupBuyDescription: "Join a group buy and unlock the lower price.",
    communityIntroTitle: "Talk to your street.", communityIntroDescription: "Ask, share, and hear what is happening nearby.", communityIntroQnaTitle: "Ask. Get answers.", communityIntroQnaDescription: "Neighbours who know reply fast.", communityIntroFreeBoardTitle: "Say what is on your mind.", communityIntroFreeBoardDescription: "Post anything — someone nearby will care.", communityIntroLocalNoticeboardTitle: "Share what you know.", communityIntroLocalNoticeboardDescription: "Post the tip that saves a neighbour a headache.", communityIntroEventsTitle: "Find something to do.", communityIntroEventsDescription: "Local events this week, or post your own.", communityIntroRecommendationsTitle: "Pass on a good find.", communityIntroRecommendationsDescription: "Name the place your neighbours should try.", communityIntroTogetherTitle: "Find your people.", communityIntroTogetherDescription: "Start a group, or join one nearby.", communityIntroImmigrationTitle: "New here? Ask away.", communityIntroImmigrationDescription: "Real answers from people who have done it.",
    ...
    listingBreadcrumbMarket: "Market", listingCategoryNav: "Listing category", listingPhotoPrevious: "Previous photo", listingPhotoNext: "Next photo", listingChoosePhoto: "Choose photo", listingCloseGallery: "Close photo gallery",
    listingSave: "Save listing", listingUnsave: "Remove from saved items", listingDelete: "Delete listing", listingDeleting: "Deleting...", listingMarkSold: "Mark as sold", listingMarkingSold: "Marking sold...",
    listingMessage: "Message", listingOpeningChat: "Opening chat...", listingMakeOffer: "Make an offer", listingRequestToBuy: "Request to buy", listingSendOffer: "Send offer", listingSendRequest: "Send request", listingSending: "Sending...",
    listingOfferAmount: "Offer amount", listingOfferInvalid: "Enter a valid offer amount.", listingOfferSent: "Offer sent to the seller.", listingOfferFailed: "Offer request did not start", listingAlreadySold: "This listing has already been sold.",
    listingCopyLinkFailed: "Unable to copy this listing link. Please try again.", listingDelivery: "Delivery", listingDescription: "Description", listingUnconfirmed: "Details the seller has not confirmed",
    listingSellerOnline: "Seller is online", listingSellerOffline: "Seller is offline", listingNoRatings: "No ratings yet", listingLocalMember: "Local member", listingMeetAt: "Meet at", listingOffers: "Offers", listingOffersLoading: "Loading...",
    listingAccept: "Accept", listingDecline: "Decline", listingPickupNote: "Pickup time, delivery note, or anything useful...",
    listingCommentsTitle: "Comments", listingCommentPlaceholder: "Ask a question or leave a comment...", listingCommentPost: "Post", listingCommentPosting: "Posting...", listingCommentReply: "Reply", listingCommentHideReplies: "Hide replies",
    listingCommentEdit: "Edit comment", listingCommentUpvote: "Upvote comment", listingCommentDownvote: "Downvote comment", listingCommentDeleted: "This comment was deleted.", listingCommentDeleteConfirm: "Delete this comment? Replies will remain visible.",
    listingCommentLoading: "Loading comments", listingCommentLoginPost: "Please log in to post a comment.", listingCommentLoginVote: "Please log in to vote on a comment.", listingCommentLoadFailed: "Unable to load comments right now.",
    listingCommentPostFailed: "Unable to post your comment right now.", listingCommentUpdateFailed: "Unable to update this comment.", listingCommentDeleteFailed: "Unable to delete this comment.", listingCommentVoteFailed: "Unable to record your vote.", listingCommentJustNow: "Just now", listingCommentEdited: "Edited",
    listingSafetyTools: "Listing safety tools", listingReport: "Report", listingReportListing: "Report listing", listingBlockSeller: "Block seller", listingBlock: "Block", listingReportClose: "Close report form", listingReportReason: "Reason",
    listingReportScam: "Scam or fraud", listingReportProhibited: "Prohibited item", listingReportInappropriate: "Inappropriate content", listingReportHarassment: "Harassment", listingReportOther: "Other", listingReportSpam: "Spam", listingReportDetails: "Tell us what happened",
    listingReportSubmit: "Submit report", listingReportSubmitting: "Submitting...", listingReportThanks: "Thanks. Your report has been sent to our moderation team.", listingReportFailed: "Unable to submit this report right now.", listingBlockFailed: "Unable to block this seller right now.",
    marketMoreToExplore: "MORE TO EXPLORE", marketMoreInCategory: "More in this category", marketOpenFilters: "Open filters", marketCloseFilters: "Close filters", marketListingPages: "Listing pages", marketFeedLabel: "Listings", marketFreshFinds: "Fresh finds",
  ...
  ko: {
    ...
    marketIntroTitle: "옆집에서 온 물건.", marketIntroDescription: "오늘 이웃이 올린 물건을 확인해 보세요.", marketIntroSecondhandTitle: "중고로 더 똑똑하게.", marketIntroSecondhandDescription: "상태 좋고, 값 좋고, 5분 거리.", marketIntroGarageSaleTitle: "동네 창고를 털어보세요.", marketIntroGarageSaleDescription: "가까운 개러지 세일, 서두르는 사람이 임자.", marketIntroMovingSaleTitle: "이사 갑니다. 기회입니다.", marketIntroMovingSaleDescription: "다 팔고 떠나요. 먼저 찜하세요.", marketIntroTwoDollarShopTitle: "전 품목 $2.", marketIntroTwoDollarShopDescription: "작은 값에 확실한 이득. 지금 담으세요.", marketIntroGroupBuyTitle: "같이 사면 더 쌉니다.", marketIntroGroupBuyDescription: "공동구매에 참여하고 더 낮은 가격을 여세요.",
    communityIntroTitle: "우리 동네와 이야기해요.", communityIntroDescription: "묻고, 나누고, 동네 소식을 들어보세요.", communityIntroQnaTitle: "물어보면 답이 옵니다.", communityIntroQnaDescription: "아는 이웃이 빠르게 답해줘요.", communityIntroFreeBoardTitle: "생각나는 대로 적어보세요.", communityIntroFreeBoardDescription: "무슨 이야기든 좋아요. 누군가 반응합니다.", communityIntroLocalNoticeboardTitle: "아는 것을 나눠주세요.", communityIntroLocalNoticeboardDescription: "이웃의 수고를 덜어줄 정보를 남겨보세요.", communityIntroEventsTitle: "이번 주, 뭐 하지?", communityIntroEventsDescription: "가까운 행사를 찾거나 직접 열어보세요.", communityIntroRecommendationsTitle: "좋은 곳을 알려주세요.", communityIntroRecommendationsDescription: "이웃이 가봐야 할 곳을 추천해 주세요.", communityIntroTogetherTitle: "함께할 사람을 찾아요.", communityIntroTogetherDescription: "모임을 만들거나, 가까운 모임에 참여하세요.", communityIntroImmigrationTitle: "처음이신가요? 물어보세요.", communityIntroImmigrationDescription: "먼저 겪은 사람들의 진짜 답이 있어요.",
    ...
    listingBreadcrumbMarket: "마켓", listingCategoryNav: "상품 카테고리", listingPhotoPrevious: "이전 사진", listingPhotoNext: "다음 사진", listingChoosePhoto: "사진 선택", listingCloseGallery: "사진 갤러리 닫기",
    listingSave: "찜하기", listingUnsave: "찜 해제", listingDelete: "상품 삭제", listingDeleting: "삭제 중…", listingMarkSold: "판매 완료로 변경", listingMarkingSold: "변경 중…",
    listingMessage: "메시지", listingOpeningChat: "채팅 여는 중…", listingMakeOffer: "가격 제안", listingRequestToBuy: "구매 요청", listingSendOffer: "제안 보내기", listingSendRequest: "요청 보내기", listingSending: "보내는 중…",
    listingOfferAmount: "제안 금액", listingOfferInvalid: "올바른 금액을 입력해 주세요.", listingOfferSent: "판매자에게 제안을 보냈습니다.", listingOfferFailed: "제안을 보내지 못했습니다", listingAlreadySold: "이미 판매된 상품입니다.",
    listingCopyLinkFailed: "링크를 복사하지 못했습니다. 다시 시도해 주세요.", listingDelivery: "거래 방법", listingDescription: "상품 설명", listingUnconfirmed: "판매자가 확인하지 않은 정보",
    listingSellerOnline: "판매자 접속 중", listingSellerOffline: "판매자 오프라인", listingNoRatings: "아직 평가가 없습니다", listingLocalMember: "동네 이웃", listingMeetAt: "거래 장소", listingOffers: "받은 제안", listingOffersLoading: "불러오는 중…",
    listingAccept: "수락", listingDecline: "거절", listingPickupNote: "픽업 시간이나 배송 관련 메모를 남겨 주세요…",
    listingCommentsTitle: "댓글", listingCommentPlaceholder: "궁금한 점이나 의견을 남겨 주세요…", listingCommentPost: "등록", listingCommentPosting: "등록 중…", listingCommentReply: "답글", listingCommentHideReplies: "답글 숨기기",
    listingCommentEdit: "댓글 수정", listingCommentUpvote: "추천", listingCommentDownvote: "비추천", listingCommentDeleted: "삭제된 댓글입니다.", listingCommentDeleteConfirm: "댓글을 삭제할까요? 답글은 그대로 남습니다.",
    listingCommentLoading: "댓글 불러오는 중", listingCommentLoginPost: "댓글을 남기려면 로그인해 주세요.", listingCommentLoginVote: "추천하려면 로그인해 주세요.", listingCommentLoadFailed: "댓글을 불러오지 못했습니다.",
    listingCommentPostFailed: "댓글을 등록하지 못했습니다.", listingCommentUpdateFailed: "댓글을 수정하지 못했습니다.", listingCommentDeleteFailed: "댓글을 삭제하지 못했습니다.", listingCommentVoteFailed: "추천을 반영하지 못했습니다.", listingCommentJustNow: "방금", listingCommentEdited: "수정됨",
    listingSafetyTools: "안전 거래 도구", listingReport: "신고", listingReportListing: "상품 신고", listingBlockSeller: "판매자 차단", listingBlock: "차단", listingReportClose: "신고 창 닫기", listingReportReason: "신고 사유",
    listingReportScam: "사기 의심", listingReportProhibited: "금지 물품", listingReportInappropriate: "부적절한 콘텐츠", listingReportHarassment: "괴롭힘", listingReportOther: "기타", listingReportSpam: "스팸", listingReportDetails: "무슨 일이 있었는지 알려 주세요",
    listingReportSubmit: "신고 접수", listingReportSubmitting: "접수 중…", listingReportThanks: "신고가 접수되었습니다. 운영팀이 확인합니다.", listingReportFailed: "신고를 접수하지 못했습니다.", listingBlockFailed: "판매자를 차단하지 못했습니다.",
    marketMoreToExplore: "더 둘러보기", marketMoreInCategory: "이 카테고리의 다른 상품", marketOpenFilters: "필터 열기", marketCloseFilters: "필터 닫기", marketListingPages: "상품 목록 페이지", marketFeedLabel: "상품 목록", marketFreshFinds: "새로 올라온 상품",
    marketTryAnother: "다른 카테고리나 가까운 지역을 확인해 보세요.", marketEmptySecondhand: "등록된 상품이 없습니다", marketEmptyGarageSale: "등록된 차고 세일이 없습니다", marketEmptyMovingSale: "등록된 이사 세일이 없습니다", marketEmptyTwoDollar: "등록된 상품이 없습니다",
  },
} as const;
