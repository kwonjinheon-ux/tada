...
const copy = {
  en: {
    ...
    bargainPlanVisitIntro: "Request a 30-minute pickup for this item. This is a visit request, not a completed purchase. The seller must confirm it.", bargainPickupPrivacyNote: "The exact address is shared only after confirmation.", bargainPickupDismissHint: "Click outside to cancel your pickup request", dialogCloseHint: "Click outside to close", confirmOk: "OK",
  ...
  ko: {
    ...
    bargainPlanVisitIntro: "이 상품에 대해 30분 픽업을 요청합니다. 구매 확정이 아니라 방문 요청이며, 판매자가 확인해야 합니다.", bargainPickupPrivacyNote: "정확한 주소는 판매자가 확인한 후에만 공개됩니다.", bargainPickupDismissHint: "바깥쪽을 클릭하면 픽업 요청이 취소됩니다", dialogCloseHint: "바깥쪽을 클릭하면 닫힙니다", confirmOk: "확인",
