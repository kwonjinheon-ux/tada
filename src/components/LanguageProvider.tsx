...
const copy = {
  en: {
    search: "Search for items...", market: "Market", jobs: "Jobs", services: "Services", community: "Community", create: "Create", home: "Home", messages: "Messages", categories: "Categories", more: "More",
    ...
    communityCategoryLocalNoticeboard: "Local Noticeboard", communityCategoryEvents: "Events", communityCategoryQnA: "Q&A", communityCategoryRecommendations: "Recommendations", communityCategoryFreeStuff: "Buy Nothing / Free Stuff", communityCategoryLostFound: "Lost & Found", communityCategoryParentsKids: "Parents & Kids", communityCategoryJobsServices: "Jobs & Services", communityCategoryHousingFlatmates: "Housing & Flatmates", communityCategoryStudyLanguage: "Study & Language", communityCategoryClubsMeetups: "Clubs & Meetups",
  ...
  ko: {
    search: "물품 검색...", market: "마켓", jobs: "일자리", services: "서비스", community: "커뮤니티", create: "등록", home: "홈", messages: "메시지", categories: "카테고리", more: "더보기",
    ...
    communityCategoryLocalNoticeboard: "동네 게시판", communityCategoryEvents: "이벤트", communityCategoryQnA: "질문답변", communityCategoryRecommendations: "추천", communityCategoryFreeStuff: "무료 나눔", communityCategoryLostFound: "분실물", communityCategoryParentsKids: "육아", communityCategoryJobsServices: "구인·구직", communityCategoryHousingFlatmates: "주거·룸메이트", communityCategoryStudyLanguage: "공부·어학", communityCategoryClubsMeetups: "모임·동호회",
