...
const copy = {
  en: {
    ...
    activeJourney: "Active Journey", previousJourney: "Previous journey", nextJourney: "Next journey", journeyOffer: "Offer", journeyAccepted: "Accepted", journeyMeet: "Meet", journeyComplete: "Complete", newOffers: "new offers", bestOffer: "Best offer", reviewOffers: "Review offers", openConversation: "Open conversation",
  },
  ko: {
    ...
    activeJourney: "진행 중인 거래", previousJourney: "이전 거래", nextJourney: "다음 거래", journeyOffer: "제안", journeyAccepted: "수락됨", journeyMeet: "만남", journeyComplete: "완료", newOffers: "개의 새 제안", bestOffer: "최고 제안가", reviewOffers: "제안 확인하기", openConversation: "대화 열기",
  },
} as const;
