...
const copy = {
  ...
  ko: {
    ...
    communityCategoryLocalNoticeboard: "뉴질랜드 생활", communityCategoryEvents: "이벤트", communityCategoryQnA: "질문답변", communityCategoryRecommendations: "추천", communityCategoryTogether: "같이해요", communityCategoryImmigration: "이민", communityCategoryVisa: "비자", communityCategoryWorkingHoliday: "워홀",
