...
export function CommunityPostActions({ postId, title, body, commentCount = 0, score = 0, myVote = 0, shareCount = 0, initialIsSaved = false, onCommentsToggle, commentsOpen = false, hideComments = false }: { postId: string; title?: string; body?: string; commentCount?: number; score?: number; myVote?: -1 | 0 | 1; shareCount?: number; initialIsSaved?: boolean; onCommentsToggle?: () => void; commentsOpen?: boolean; hideComments?: boolean }) {
  const { t } = useLanguage();
