    ...
    <PageContainer className="community-detail-container">
      ...
      <article className="ui-card community-detail-post">
        <header className="community-detail-post-header">
          ...
          <div className="community-detail-author"><CommunityPostAuthor name={post.authorName} avatarUrl={post.authorAvatarUrl} className="community-detail-author-identity" avatarClassName="community-detail-author-avatar" />{post.isOwner ? <CommunityPostOwnerMenu onEdit={openEditDialog} onDelete={() => setIsDeleteDialogOpen(true)} /> : null}</div>
        </header>
