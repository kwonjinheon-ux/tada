...
export function SelectMenu({ id, name, label, icon, placeholder, options, value, onChange, className = "", disabled = false, hideLabel = false }: { id: string; name: string; label: string; icon?: string; placeholder: string; options: readonly SelectMenuOption[]; value: string; onChange: (value: string) => void; className?: string; disabled?: boolean; hideLabel?: boolean }) {
