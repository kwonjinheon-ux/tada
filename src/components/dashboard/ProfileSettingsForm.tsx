    ...
    <div className="profile-settings-grid profile-settings-grid-refined">
      <div className="profile-main-column">
        ...
        <section className={`profile-panel profile-account-panel ${isAccountOpen ? "is-open" : ""}`}>
          <button className="profile-section-toggle" type="button" aria-expanded={isAccountOpen} onClick={() => setIsAccountOpen((value) => !value)}><span><i className="fa-regular fa-user" aria-hidden="true" /> {t("account")}</span><i className={`fa-solid fa-chevron-${isAccountOpen ? "up" : "down"}`} aria-hidden="true" /></button>
        ...
        <section className={`profile-panel profile-security-panel ${isSecurityOpen ? "is-open" : ""}`}>
          <button className="profile-security-toggle" type="button" aria-expanded={isSecurityOpen} onClick={() => setIsSecurityOpen((value) => !value)}><span><i className="fa-solid fa-lock" /> {t("security")}</span><i className={`fa-solid fa-chevron-${isSecurityOpen ? "up" : "down"}`} /></button>
