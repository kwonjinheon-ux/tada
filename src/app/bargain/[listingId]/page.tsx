...
type BargainRow = {
  id: string; owner_id: string | null; title: string; description: string; bargain_type: "moving-sale" | "garage-sale"; main_location: string | null; sub_location: string | null;
...
export default async function BargainSaleDetailPage({ params }: { params: Promise<{ listingId: string }> }) {
  ...
  const detail: BargainSaleDetail = {
    ...
    seller: { name: seller?.display_name ?? "Tada seller", avatarUrl: sellerAvatarUrl },
