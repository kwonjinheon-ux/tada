      ...
      <div className="dashboard-content">
        ...
        <section className="dashboard-section" id="manage-listings">
          <div className="dashboard-section-heading">
            ...
            <div><button className="dashboard-button is-soft" type="button"><i className="fa-solid fa-rocket" /> {isJobsDashboard ? "Promote Job" : "Promote Listing"}</button><Link className="dashboard-button" href="/market/create"><i className="fa-solid fa-pen-to-square" /> {isJobsDashboard ? "Create New Job" : "Create New Post"}</Link></div>
          </div>
